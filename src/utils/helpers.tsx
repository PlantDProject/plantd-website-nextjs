...
export const homeAboutData = [
    { image: `next-images/homepage/homeAbout1.webp`, name: 'Individual', url: "" },
    { image: `next-images/homepage/homeAbout2.webp`, name: 'Businesses', url: "/business" },
    { image: `next-images/homepage/homeAbout3.webp`, name: 'Fundraising', url: "/fundraiser" },
];
